...
public class QueueObjectMessageReceiver implements MessageListener {
	 ...
	 public QueueObjectMessageReceiver() 
...
//				student=objectMessage.getBody(student.getClass());
	  ...
	  public static void main(String[] args) 
	          throws NamingException,JMSException {
		  QueueObjectMessageReceiver rec=new QueueObjectMessageReceiver();
	       try {
